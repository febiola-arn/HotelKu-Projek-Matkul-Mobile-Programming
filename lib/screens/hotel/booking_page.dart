              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.of(context).pop(); // Close hotel detail
                    // Note: Ideally we should use a better navigation strategy
                    // For now, we pop to home and then push my bookings?
                    // Or access the main layout controller if exists.
                    // Simple approach: Replace everything with Home and navigate to bookings?
                    // Let's just pop to Home and then push MyBookings
                    
                    Navigator.of(context).pushNamedAndRemoveUntil('/home', (route) => false);
                    // We might need a direct route to my bookings or handle it via Home tab index if it were a tab bar.
                    // Since specific MyBookings route wasn't explicitly set in main.dart map earlier (only /home), 
                    // let's assume valid navigation wrapper or just push the page directly.
                    
                    // Actually main.dart has:
                    // '/home': (context) => const HomePage(),
                    // MyBookingsPage is usually accessed from Profile or Home.
                    // Let's push MyBookingsPage directly on top of Home.
                  },
